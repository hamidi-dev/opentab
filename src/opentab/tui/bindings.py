...
REGISTRY: tuple[Context, ...] = (
    ...
    Context(
        ...
        (
            ...
            Action("back", ("esc",), "reader / session scope / overlay back"),
            ...
            Action("reset_filters", ("R",), "clear every search filter, keeping the query"),
            Action("scope_project", ("p",), "edit the project scope"),
            Action("scope_harness", ("H",), "choose the harness filter"),
            Action("scope_date", ("d",), "edit UTC message-date bounds"),
